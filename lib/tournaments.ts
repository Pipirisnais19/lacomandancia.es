...
export const TOURNAMENTS: Tournament[] = [
  {
    ...
    fieldDecks: [
      ...
      { player: "Iván Guerrero", commander: "Anowon, the Ruin Thief", colorIdentity: ["U", "B"] },
    ...
    manaCurve: [
      ...
      { cmc: "1", avgPerDeck: 10.2 },
      { cmc: "2", avgPerDeck: 21.9 },
      { cmc: "3", avgPerDeck: 13.0 },
      { cmc: "4", avgPerDeck: 7.2 },
      { cmc: "5", avgPerDeck: 3.3 },
      { cmc: "6+", avgPerDeck: 6.3 },
    ],
    avgLandsPerDeck: 35.3,
    rulesSections: [
      {
  ...
  },
  {
    ...
    fieldDecks: [
      { player: "Zordiark", commander: "Alela, Artful Provocateur", colorIdentity: ["W", "U", "B"] },
      { player: "robercametome", commander: "Omo, Queen of Vesuva", colorIdentity: ["G", "U"] },
      { player: "KururuChan", commander: "Doctor Doom, King of Latveria", colorIdentity: ["U", "B", "R"] },
      { player: "RoyAwesome", commander: "Hope Estheim", colorIdentity: ["W", "U"] },
      { player: "Alruca", commander: "Vren, the Relentless", colorIdentity: ["B", "U"] },
      { player: "otori", commander: "Sokka, Tenacious Tactician", colorIdentity: ["R", "U", "W"] },
      { player: "asnuke33", commander: "Talion, the Kindly Lord", colorIdentity: ["B", "U"] },
      { player: "SilvanoElLechuguero", commander: "Kadena, Slinking Sorcerer", colorIdentity: ["B", "G", "U"] },
    ],
    topCards: [
      { name: "Command Tower", count: 8, land: true },
      { name: "Sol Ring", count: 8 },
      { name: "Arcane Signet", count: 7 },
      { name: "Exotic Orchard", count: 6, land: true },
      { name: "Negate", count: 6, color: "U" },
      { name: "Counterspell", count: 5, color: "U" },
      { name: "Talisman of Dominance", count: 5 },
      { name: "Aetherize", count: 4, color: "U" },
      { name: "Choked Estuary", count: 4, land: true },
      { name: "Drowned Catacomb", count: 4, land: true },
    ],
    manaCurve: [
      { cmc: "0", avgPerDeck: 0.3 },
      { cmc: "1", avgPerDeck: 7.8 },
      { cmc: "2", avgPerDeck: 21.8 },
      { cmc: "3", avgPerDeck: 13.8 },
      { cmc: "4", avgPerDeck: 10.4 },
      { cmc: "5", avgPerDeck: 4.6 },
      { cmc: "6+", avgPerDeck: 4.9 },
    ],
    avgLandsPerDeck: 35.6,
    format: {
      jornadas: 8,
      bestOf: 4,
      schedule:
